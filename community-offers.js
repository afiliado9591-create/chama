(()=>{
  ...
  function cardFor(item){
    ...
    const share=document.createElement('button');share.type='button';share.className='chama-community-share';share.textContent='↗ Compartilhar';share.onclick=()=>shareOffer(item,share);actions.append(a,share);body.appendChild(actions);card.appendChild(body);return card;
  }
