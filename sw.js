...
function injectSafeUi(html) {
  ...
  const menuMarker = 'app-menu.js?v=15';
  ...
  const homeMarker = 'home-conversations-search.js?v=8';
  ...
  const affiliateMenuMarker = 'affiliate-menu.js?v=10';
  const layoutRefreshMarker = 'layout-refresh.js?v=3';
  ...
  const professionalPromoMarker = 'professional-promo.js?v=3';
  ...
  const adminProfileAffiliateLinksMarker = 'admin-profile-affiliate-links.js?v=2';
  ...
  if (!out.includes('window.chamaSendMessage=saveMessage;')) {
    out = out.replace('  $("composer").addEventListener("submit", async e=>{', '  window.chamaSendMessage=saveMessage;\n\n  $("composer").addEventListener("submit", async e=>{');
  }
  ...
  if (!out.includes(menuMarker)) out = out.replace('</body>', `<script src="./app-menu.js?v=15"></script></body>`);
  ...
  if (!out.includes(homeMarker)) out = out.replace('</body>', `<script src="./home-conversations-search.js?v=8"></script></body>`);
  ...
  if (!out.includes(affiliateMenuMarker)) out = out.replace('</body>', `<script src="./affiliate-menu.js?v=10"></script></body>`);
  if (!out.includes(layoutRefreshMarker)) out = out.replace('</body>', `<script src="./layout-refresh.js?v=3"></script></body>`);
  ...
  if (!out.includes(professionalPromoMarker)) out = out.replace('</body>', `<script src="./professional-promo.js?v=3"></script></body>`);
  ...
  if (!out.includes(adminProfileAffiliateLinksMarker)) out = out.replace('</body>', `<script src="./admin-profile-affiliate-links.js?v=2"></script></body>`);
