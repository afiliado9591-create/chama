...
function injectExtras(html){
  ...
  inject('<script src="./search.js?v=40"></script>','search.js?v=40');
  inject('<script type="module" src="./auth-persistence.js?v=40"></script>','auth-persistence.js?v=40');
  inject('<script type="module" src="./share.js?v=40"></script>','share.js?v=40');
  inject('<script type="module" src="./public-profile.js?v=40"></script>','public-profile.js?v=40');
  inject('<script src="./brand-brazil.js?v=40"></script>','brand-brazil.js?v=40');
  inject('<script src="./contact-open-chat.js?v=40"></script>','contact-open-chat.js?v=40');
  inject('<script type="module" src="./forgot-password.js?v=40"></script>','forgot-password.js?v=40');
  inject('<script src="./clickable-links.js?v=40"></script>','clickable-links.js?v=40');
  inject('<script type="module" src="./friends.js?v=40"></script>','friends.js?v=40');
  inject('<script src="./media-render-safe.js?v=40"></script>','media-render-safe.js?v=40');
  inject('<script type="module" src="./media-chat.js?v=40"></script>','media-chat.js?v=40');
  inject('<script src="./chat-safe-ui.js?v=40"></script>','chat-safe-ui.js?v=40');
  inject('<script type="module" src="./notifications.js?v=40"></script>','notifications.js?v=40');
  inject('<script type="module" src="./delete-messages.js?v=40"></script>','delete-messages.js?v=40');
  inject('<script type="module" src="./admin-panel.js?v=40"></script>','admin-panel.js?v=40');
  inject('<script type="module" src="./profile-type.js?v=40"></script>','profile-type.js?v=40');
  inject('<script type="module" src="./referral.js?v=40"></script>','referral.js?v=40');
  inject('<script type="module" src="./professional-profile.js?v=40"></script>','professional-profile.js?v=40');
  inject('<script type="module" src="./offers.js?v=40"></script>','offers.js?v=40');
  inject('<script type="module" src="./business-directory.js?v=40"></script>','business-directory.js?v=40');
  inject('<script src="./mobile-topbar-fix.js?v=40"></script>','mobile-topbar-fix.js?v=40');
  inject('<script type="module" src="./push-call.js?v=40"></script>','push-call.js?v=40');
  inject('<script type="module" src="./voice-call.js?v=40"></script>','voice-call.js?v=40');
  inject('<script type="module" src="./call-push-trigger.js?v=40"></script>','call-push-trigger.js?v=40');
  return html;
}
