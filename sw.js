...
function injectExtras(html){
 ...
 inject('<script src="./search.js?v=45"></script>','search.js?v=45');
 inject('<script type="module" src="./auth-persistence.js?v=45"></script>','auth-persistence.js?v=45');
 inject('<script type="module" src="./share.js?v=45"></script>','share.js?v=45');
 inject('<script type="module" src="./public-profile.js?v=45"></script>','public-profile.js?v=45');
 inject('<script src="./brand-brazil.js?v=45"></script>','brand-brazil.js?v=45');
 inject('<script src="./contact-open-chat.js?v=45"></script>','contact-open-chat.js?v=45');
 inject('<script type="module" src="./forgot-password.js?v=45"></script>','forgot-password.js?v=45');
 inject('<script src="./clickable-links.js?v=45"></script>','clickable-links.js?v=45');
 inject('<script type="module" src="./friends.js?v=45"></script>','friends.js?v=45');
 inject('<script src="./media-render-safe.js?v=45"></script>','media-render-safe.js?v=45');
 inject('<script type="module" src="./media-chat.js?v=45"></script>','media-chat.js?v=45');
 inject('<script src="./chat-safe-ui.js?v=45"></script>','chat-safe-ui.js?v=45');
 inject('<script type="module" src="./notifications.js?v=45"></script>','notifications.js?v=45');
 inject('<script type="module" src="./delete-messages.js?v=45"></script>','delete-messages.js?v=45');
 inject('<script type="module" src="./admin-panel.js?v=45"></script>','admin-panel.js?v=45');
 inject('<script type="module" src="./profile-type.js?v=45"></script>','profile-type.js?v=45');
 inject('<script type="module" src="./referral.js?v=45"></script>','referral.js?v=45');
 inject('<script type="module" src="./professional-profile.js?v=45"></script>','professional-profile.js?v=45');
 inject('<script type="module" src="./offers.js?v=45"></script>','offers.js?v=45');
 inject('<script type="module" src="./business-directory.js?v=45"></script>','business-directory.js?v=45');
 inject('<script src="./mobile-topbar-fix.js?v=45"></script>','mobile-topbar-fix.js?v=45');
 inject('<script type="module" src="./push-messages.js?v=45"></script>','push-messages.js?v=45');
 inject('<script type="module" src="./channels.js?v=45"></script>','channels.js?v=45');
 return html;
}
