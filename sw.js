...
function injectExtras(html){
 ...
 inject('<script src="./search.js?v=48"></script>','search.js?v=48');
 inject('<script type="module" src="./auth-persistence.js?v=48"></script>','auth-persistence.js?v=48');
 inject('<script type="module" src="./share.js?v=48"></script>','share.js?v=48');
 inject('<script type="module" src="./public-profile.js?v=48"></script>','public-profile.js?v=48');
 inject('<script src="./brand-brazil.js?v=48"></script>','brand-brazil.js?v=48');
 inject('<script src="./contact-open-chat.js?v=48"></script>','contact-open-chat.js?v=48');
 inject('<script type="module" src="./forgot-password.js?v=48"></script>','forgot-password.js?v=48');
 inject('<script src="./clickable-links.js?v=48"></script>','clickable-links.js?v=48');
 inject('<script type="module" src="./friends.js?v=48"></script>','friends.js?v=48');
 inject('<script src="./media-render-safe.js?v=48"></script>','media-render-safe.js?v=48');
 inject('<script type="module" src="./media-chat.js?v=48"></script>','media-chat.js?v=48');
 inject('<script src="./chat-safe-ui.js?v=48"></script>','chat-safe-ui.js?v=48');
 inject('<script type="module" src="./notifications.js?v=48"></script>','notifications.js?v=48');
 inject('<script type="module" src="./delete-messages.js?v=48"></script>','delete-messages.js?v=48');
 inject('<script type="module" src="./admin-panel.js?v=48"></script>','admin-panel.js?v=48');
 inject('<script type="module" src="./profile-type.js?v=48"></script>','profile-type.js?v=48');
 inject('<script type="module" src="./referral.js?v=48"></script>','referral.js?v=48');
 inject('<script type="module" src="./professional-profile.js?v=48"></script>','professional-profile.js?v=48');
 inject('<script type="module" src="./offers.js?v=48"></script>','offers.js?v=48');
 inject('<script type="module" src="./business-directory.js?v=48"></script>','business-directory.js?v=48');
 inject('<script src="./mobile-topbar-fix.js?v=48"></script>','mobile-topbar-fix.js?v=48');
 inject('<script type="module" src="./push-messages.js?v=48"></script>','push-messages.js?v=48');
 inject('<script type="module" src="./channels.js?v=48"></script>','channels.js?v=48');
 inject('<script src="./video-embeds.js?v=48"></script>','video-embeds.js?v=48');
 inject('<script src="./catalog-platforms.js?v=48"></script>','catalog-platforms.js?v=48');
 return html;
}
