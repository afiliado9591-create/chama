...
function injectExtras(html){
  ...
  inject('<script src="./search.js?v=27"></script>','search.js?v=27');
  inject('<script type="module" src="./auth-persistence.js?v=27"></script>','auth-persistence.js?v=27');
  inject('<script type="module" src="./share.js?v=27"></script>','share.js?v=27');
  inject('<script type="module" src="./public-profile.js?v=27"></script>','public-profile.js?v=27');
  inject('<script src="./brand-brazil.js?v=27"></script>','brand-brazil.js?v=27');
  inject('<script src="./contact-open-chat.js?v=27"></script>','contact-open-chat.js?v=27');
  inject('<script type="module" src="./forgot-password.js?v=27"></script>','forgot-password.js?v=27');
  inject('<script src="./clickable-links.js?v=27"></script>','clickable-links.js?v=27');
  inject('<script type="module" src="./friends.js?v=27"></script>','friends.js?v=27');
  inject('<script src="./media-render-safe.js?v=27"></script>','media-render-safe.js?v=27');
  inject('<script type="module" src="./media-chat.js?v=27"></script>','media-chat.js?v=27');
  inject('<script src="./chat-safe-ui.js?v=27"></script>','chat-safe-ui.js?v=27');
  inject('<script type="module" src="./notifications.js?v=27"></script>','notifications.js?v=27');
  inject('<script type="module" src="./delete-messages.js?v=27"></script>','delete-messages.js?v=27');
  inject('<script type="module" src="./admin-panel.js?v=27"></script>','admin-panel.js?v=27');
  inject('<script type="module" src="./profile-type.js?v=27"></script>','profile-type.js?v=27');
  inject('<script type="module" src="./referral.js?v=27"></script>','referral.js?v=27');
  inject('<script type="module" src="./professional-profile.js?v=27"></script>','professional-profile.js?v=27');
  return html;
}
