...
function injectSafeUi(html) {
  ...
  const recipientBridgeMarker = 'media-recipient-bridge.js?v=1';
  ...
  if (!out.includes(recipientBridgeMarker)) out = out.replace('</body>', `<script src="./media-recipient-bridge.js?v=1"></script></body>`);
