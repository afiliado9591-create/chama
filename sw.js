...
function injectExtras(html){
 ...
 inject('<script src="./search.js?v=51"></script>','search.js?v=51');
 inject('<script type="module" src="./auth-persistence.js?v=51"></script>','auth-persistence.js?v=51');
 inject('<script type="module" src="./share.js?v=51"></script>','share.js?v=51');
 inject('<script type="module" src="./public-profile.js?v=51"></script>','public-profile.js?v=51');
 inject('<script src="./brand-brazil.js?v=51"></script>','brand-brazil.js?v=51');
 inject('<script src="./contact-open-chat.js?v=51"></script>','contact-open-chat.js?v=51');
 inject('<script type="module" src="./forgot-password.js?v=51"></script>','forgot-password.js?v=51');
 inject('<script src="./clickable-links.js?v=51"></script>','clickable-links.js?v=51');
 inject('<script type="module" src="./friends.js?v=51"></script>','friends.js?v=51');
 inject('<script src="./media-render-safe.js?v=51"></script>','media-render-safe.js?v=51');
 inject('<script type="module" src="./media-chat.js?v=51"></script>','media-chat.js?v=51');
 inject('<script src="./chat-safe-ui.js?v=51"></script>','chat-safe-ui.js?v=51');
 inject('<script type="module" src="./notifications.js?v=51"></script>','notifications.js?v=51');
 inject('<script type="module" src="./delete-messages.js?v=51"></script>','delete-messages.js?v=51');
 inject('<script type="module" src="./admin-panel.js?v=51"></script>','admin-panel.js?v=51');
 inject('<script type="module" src="./profile-type.js?v=51"></script>','profile-type.js?v=51');
 inject('<script type="module" src="./referral.js?v=51"></script>','referral.js?v=51');
 inject('<script type="module" src="./professional-profile.js?v=51"></script>','professional-profile.js?v=51');
 inject('<script type="module" src="./offers.js?v=51"></script>','offers.js?v=51');
 inject('<script type="module" src="./business-directory.js?v=51"></script>','business-directory.js?v=51');
 inject('<script src="./mobile-topbar-fix.js?v=51"></script>','mobile-topbar-fix.js?v=51');
 inject('<script type="module" src="./push-messages.js?v=51"></script>','push-messages.js?v=51');
 inject('<script type="module" src="./channels.js?v=51"></script>','channels.js?v=51');
 inject('<script src="./video-embeds.js?v=51"></script>','video-embeds.js?v=51');
 inject('<script src="./catalog-platforms.js?v=51"></script>','catalog-platforms.js?v=51');
 inject('<script type="module" src="./home-highlights.js?v=51"></script>','home-highlights.js?v=51');
 inject('<script src="./about-privacy.js?v=51"></script>','about-privacy.js?v=51');
 inject('<script type="module" src="./admin-moderation.js?v=51"></script>','admin-moderation.js?v=51');
 return html;
}
