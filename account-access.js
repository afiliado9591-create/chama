(()=>{
  ...
  function addStyle(){
    ...
    const s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      ...
      body[data-profile-type="social"]:not([data-affiliate-day-allowed="true"]) #chamaAffiliateDayTop,
      body[data-profile-type="social"]:not([data-affiliate-day-allowed="true"]) #chamaAffiliateDayModal,
      body[data-profile-type="social"]:not([data-affiliate-day-allowed="true"]) #chamaAffiliateDayMenuLink,
      body[data-profile-type="social"]:not([data-affiliate-day-allowed="true"]) #chamaQuickMenu [data-action="day"],
