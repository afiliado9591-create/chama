(()=>{
  ...
  const PRODUCT_PREFIX="__CHAMA_PRODUCT_CONTEXT__";
  ...
  function linkifyBubble(bubble){
    ...
    if(raw.startsWith(MEDIA_PREFIX)||raw.startsWith(PRODUCT_PREFIX))return;
...
(function(){if(document.querySelector('script[data-chama-stability-loader]'))return;const s=document.createElement('script');s.src='./media-stability.js?v=4';s.dataset.chamaStabilityLoader='4';document.head.appendChild(s)})();
import("./media-chat.js?v=3").catch(e=>console.warn("Chama mídia não carregou",e));
